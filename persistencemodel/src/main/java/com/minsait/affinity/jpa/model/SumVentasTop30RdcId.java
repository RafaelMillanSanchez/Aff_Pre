...
/**
 * SumVentasTop30RdcId generated by hbm2java
 */
@Embeddable
public class SumVentasTop30RdcId  implements java.io.Serializable {
    ...
    public SumVentasTop30RdcId() {
    }

    public SumVentasTop30RdcId(String rdc, String subBrand, String baseReference, String cadena, String accType, Double sumUnidades, Double sumEuros, Double sumKg) {
       this.rdc = rdc;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SumVentasTop30RdcId) ) return false;
		 SumVentasTop30RdcId castOther = ( SumVentasTop30RdcId ) other; 
