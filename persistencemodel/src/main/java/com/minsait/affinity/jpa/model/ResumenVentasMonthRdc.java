...
/**
 * ResumenVentasMonthRdc generated by hbm2java
 */
@Entity
@Table(name="resumen_ventas_month_rdc"
    ,schema="salesforce"
)
public class ResumenVentasMonthRdc  implements java.io.Serializable {
    ...
    public ResumenVentasMonthRdc() {
    }

	
    public ResumenVentasMonthRdc(long id) {
        this.id = id;
    }
    public ResumenVentasMonthRdc(long id, String years, String months, String rdc, String brand, String brandName, Double ventas, Double ventasKg, Boolean currentMonth, String subbrandName) {
       this.id = id;
       this.years = years;
       this.months = months;
       this.rdc = rdc;
