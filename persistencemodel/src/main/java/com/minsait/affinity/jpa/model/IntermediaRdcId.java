...
/**
 * IntermediaRdcId generated by hbm2java
 */
@Embeddable
public class IntermediaRdcId  implements java.io.Serializable {
    ...
    public IntermediaRdcId() {
    }

    public IntermediaRdcId(String rdc, Integer numCustomers, String cadena, String accType, String baseReference) {
       this.rdc = rdc;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IntermediaRdcId) ) return false;
		 IntermediaRdcId castOther = ( IntermediaRdcId ) other; 
