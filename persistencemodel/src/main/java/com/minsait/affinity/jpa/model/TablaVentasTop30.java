...
/**
 * TablaVentasTop30 generated by hbm2java
 */
@Entity
@Table(name="tabla_ventas_top30"
    ,schema="salesforce"
)
public class TablaVentasTop30  implements java.io.Serializable {


     private TablaVentasTop30Id id;

    public TablaVentasTop30() {
    }

    public TablaVentasTop30(TablaVentasTop30Id id) {
       this.id = id;
    }
    ...
    @AttributeOverrides( {
        ...
        @AttributeOverride(name="unidades", column=@Column(name="unidades", precision=17, scale=17) ), 
        @AttributeOverride(name="productName", column=@Column(name="product_name") ) } )
    public TablaVentasTop30Id getId() {
        return this.id;
    }
    
    public void setId(TablaVentasTop30Id id) {
        this.id = id;
    }
