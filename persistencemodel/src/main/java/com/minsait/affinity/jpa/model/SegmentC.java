...
/**
 * SegmentC generated by hbm2java
 */
@Entity
@Table(name="segment__c"
    ,schema="salesforce"
    , uniqueConstraints = @UniqueConstraint(columnNames="sfid") 
)
public class SegmentC  implements java.io.Serializable {
    ...
    public SegmentC(Integer id) {
        this.id = id;
    }
    public SegmentC(Integer id, String businessC, String frmDescriptionC, String name, String frmHierarchyC, Boolean isdeleted, Date systemmodstamp, String txtDescriptionC, Date createddate, String sfid, String hcLastop, String hcErr) {
       this.id = id;
    ...
    @Column(name="business__c", length=18)
