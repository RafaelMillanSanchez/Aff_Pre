...
/**
 * AcuerdoComercialIntermediaId generated by hbm2java
 */
@Embeddable
public class AcuerdoComercialIntermediaId  implements java.io.Serializable {
    ...
    public AcuerdoComercialIntermediaId() {
    }

    public AcuerdoComercialIntermediaId(Integer customerCode, String subbrand, Date fechaInicio, Date fechaFin, String sfidCustomer, String sfidSubbrand) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AcuerdoComercialIntermediaId) ) return false;
		 AcuerdoComercialIntermediaId castOther = ( AcuerdoComercialIntermediaId ) other; 
