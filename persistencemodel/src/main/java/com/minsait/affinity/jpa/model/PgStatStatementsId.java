...
public class PgStatStatementsId  implements java.io.Serializable {
    ...
    public PgStatStatementsId(Long userid, Long dbid, Long queryid, String query, Long calls, Double totalTime, Double minTime, Double maxTime, Double meanTime, Double stddevTime, Long rows, Long sharedBlksHit, Long sharedBlksRead, Long sharedBlksDirtied, Long sharedBlksWritten, Long localBlksHit, Long localBlksRead, Long localBlksDirtied, Long localBlksWritten, Long tempBlksRead, Long tempBlksWritten, Double blkReadTime, Double blkWriteTime) {
       this.userid = userid;
       this.dbid = dbid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PgStatStatementsId) ) return false;
 ...
 && ( (this.getCalls()==castOther.getCalls()) || ( this.getCalls()!=null && castOther.getCalls()!=null && this.getCalls().equals(castOther.getCalls()) ) )
 && ( (this.getTotalTime()==castOther.getTotalTime()) || ( this.getTotalTime()!=null && castOther.getTotalTime()!=null && this.getTotalTime().equals(castOther.getTotalTime()) ) )
 && ( (this.getMinTime()==castOther.getMinTime()) || ( this.getMinTime()!=null && castOther.getMinTime()!=null && this.getMinTime().equals(castOther.getMinTime()) ) )
 && ( (this.getMaxTime()==castOther.getMaxTime()) || ( this.getMaxTime()!=null && castOther.getMaxTime()!=null && this.getMaxTime().equals(castOther.getMaxTime()) ) )
 && ( (this.getMeanTime()==castOther.getMeanTime()) || ( this.getMeanTime()!=null && castOther.getMeanTime()!=null && this.getMeanTime().equals(castOther.getMeanTime()) ) )
 && ( (this.getStddevTime()==castOther.getStddevTime()) || ( this.getStddevTime()!=null && castOther.getStddevTime()!=null && this.getStddevTime().equals(castOther.getStddevTime()) ) )
 && ( (this.getRows()==castOther.getRows()) || ( this.getRows()!=null && castOther.getRows()!=null && this.getRows().equals(castOther.getRows()) ) )
 && ( (this.getSharedBlksHit()==castOther.getSharedBlksHit()) || ( this.getSharedBlksHit()!=null && castOther.getSharedBlksHit()!=null && this.getSharedBlksHit().equals(castOther.getSharedBlksHit()) ) )
 && ( (this.getSharedBlksRead()==castOther.getSharedBlksRead()) || ( this.getSharedBlksRead()!=null && castOther.getSharedBlksRead()!=null && this.getSharedBlksRead().equals(castOther.getSharedBlksRead()) ) )
 && ( (this.getSharedBlksDirtied()==castOther.getSharedBlksDirtied()) || ( this.getSharedBlksDirtied()!=null && castOther.getSharedBlksDirtied()!=null && this.getSharedBlksDirtied().equals(castOther.getSharedBlksDirtied()) ) )
 && ( (this.getSharedBlksWritten()==castOther.getSharedBlksWritten()) || ( this.getSharedBlksWritten()!=null && castOther.getSharedBlksWritten()!=null && this.getSharedBlksWritten().equals(castOther.getSharedBlksWritten()) ) )
 && ( (this.getLocalBlksHit()==castOther.getLocalBlksHit()) || ( this.getLocalBlksHit()!=null && castOther.getLocalBlksHit()!=null && this.getLocalBlksHit().equals(castOther.getLocalBlksHit()) ) )
 && ( (this.getLocalBlksRead()==castOther.getLocalBlksRead()) || ( this.getLocalBlksRead()!=null && castOther.getLocalBlksRead()!=null && this.getLocalBlksRead().equals(castOther.getLocalBlksRead()) ) )
 && ( (this.getLocalBlksDirtied()==castOther.getLocalBlksDirtied()) || ( this.getLocalBlksDirtied()!=null && castOther.getLocalBlksDirtied()!=null && this.getLocalBlksDirtied().equals(castOther.getLocalBlksDirtied()) ) )
 && ( (this.getLocalBlksWritten()==castOther.getLocalBlksWritten()) || ( this.getLocalBlksWritten()!=null && castOther.getLocalBlksWritten()!=null && this.getLocalBlksWritten().equals(castOther.getLocalBlksWritten()) ) )
 && ( (this.getTempBlksRead()==castOther.getTempBlksRead()) || ( this.getTempBlksRead()!=null && castOther.getTempBlksRead()!=null && this.getTempBlksRead().equals(castOther.getTempBlksRead()) ) )
 && ( (this.getTempBlksWritten()==castOther.getTempBlksWritten()) || ( this.getTempBlksWritten()!=null && castOther.getTempBlksWritten()!=null && this.getTempBlksWritten().equals(castOther.getTempBlksWritten()) ) )
 && ( (this.getBlkReadTime()==castOther.getBlkReadTime()) || ( this.getBlkReadTime()!=null && castOther.getBlkReadTime()!=null && this.getBlkReadTime().equals(castOther.getBlkReadTime()) ) )
 && ( (this.getBlkWriteTime()==castOther.getBlkWriteTime()) || ( this.getBlkWriteTime()!=null && castOther.getBlkWriteTime()!=null && this.getBlkWriteTime().equals(castOther.getBlkWriteTime()) ) );
   }
