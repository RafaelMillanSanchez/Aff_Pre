...
/**
 * VentasRefClaveIntermedia generated by hbm2java
 */
@Entity
@Table(name="ventas_ref_clave_intermedia"
    ,schema="salesforce"
)
public class VentasRefClaveIntermedia  implements java.io.Serializable {


     private VentasRefClaveIntermediaId id;

    public VentasRefClaveIntermedia() {
    }

    public VentasRefClaveIntermedia(VentasRefClaveIntermediaId id) {
       this.id = id;
    }
    ...
    public VentasRefClaveIntermediaId getId() {
        return this.id;
    }
    
    public void setId(VentasRefClaveIntermediaId id) {
        this.id = id;
    }
