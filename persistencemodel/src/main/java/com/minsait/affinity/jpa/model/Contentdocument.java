...
/**
 * Contentdocument generated by hbm2java
 */
@Entity
...
public class Contentdocument  implements java.io.Serializable {
    ...
    public Contentdocument(Integer id) {
        this.id = id;
    }
    public Contentdocument(Integer id, Date createddate, String hcErr, String hcLastop, Boolean isdeleted, String sfid, Date systemmodstamp) {
       this.id = id;
