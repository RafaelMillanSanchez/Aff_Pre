...
/**
 * BaseReferenceC generated by hbm2java
 */
@Entity
@Table(name="base_reference__c"
    ,schema="salesforce"
    , uniqueConstraints = @UniqueConstraint(columnNames="sfid") 
)
public class BaseReferenceC  implements java.io.Serializable {
    ...
    public BaseReferenceC() {
    }

	
    public BaseReferenceC(Integer id) {
        this.id = id;
    }
    public BaseReferenceC(Integer id, Date createddate, Boolean isdeleted, String name, Date systemmodstamp, String frmHierarchyC, String txtDescriptionC, String sfid, String hcLastop, String hcErr) {
       this.id = id;
