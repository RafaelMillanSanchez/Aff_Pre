...
/**
 * TablaVentasTop30Id generated by hbm2java
 */
@Embeddable
public class TablaVentasTop30Id  implements java.io.Serializable {
    ...
    public TablaVentasTop30Id() {
    }

    public TablaVentasTop30Id(String customerCode, String subBrand, String baseReference, Double netSales, Double kgSales, String cadena, String accType, String rdc, String tam, String country, Double unidades, String productName) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TablaVentasTop30Id) ) return false;
		 TablaVentasTop30Id castOther = ( TablaVentasTop30Id ) other; 
 ...
 && ( (this.getUnidades()==castOther.getUnidades()) || ( this.getUnidades()!=null && castOther.getUnidades()!=null && this.getUnidades().equals(castOther.getUnidades()) ) )
 && ( (this.getProductName()==castOther.getProductName()) || ( this.getProductName()!=null && castOther.getProductName()!=null && this.getProductName().equals(castOther.getProductName()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getUnidades() == null ? 0 : this.getUnidades().hashCode() );
