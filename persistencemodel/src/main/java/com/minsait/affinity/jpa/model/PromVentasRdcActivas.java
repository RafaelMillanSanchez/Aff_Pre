...
/**
 * PromVentasRdcActivas generated by hbm2java
 */
@Entity
@Table(name="prom_ventas_rdc_activas"
    ,schema="salesforce"
)
public class PromVentasRdcActivas  implements java.io.Serializable {


     private PromVentasRdcActivasId id;

    public PromVentasRdcActivas() {
    }

    public PromVentasRdcActivas(PromVentasRdcActivasId id) {
       this.id = id;
    }
    ...
    public PromVentasRdcActivasId getId() {
        return this.id;
    }
    
    public void setId(PromVentasRdcActivasId id) {
        this.id = id;
    }
